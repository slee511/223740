...
Built to replace the one below, which loops over Google Trend 150+ times per load. Apparently Google doesn't allow that. This one doesn't use Google Trend at all, but it should also add some value. I'll keep making. 
